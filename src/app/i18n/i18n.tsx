        ...
        resources: {
            en: {
                translation: {
                    ...
                    'sendTips': 'Press Enter to send, Shift+Enter to add a new line',
            ...
            zh: {
                translation: {
                    ...
                    'sendTips': '按 Enter 发送，Shift+Enter 换行',
                    ...
                    "tutorialEndingSummary": `有了自定义快捷指令，你可以根据自身需求，打造一套属于自己的工具链，比如：\n\n- 在模拟面试中让 AI 协助回答不会的问题；\n- 让 AI 提炼句子中的短语，并提供一些同义词，扩充自己的词汇量；\n- 在未来的更新中，你还能够通过快捷指令与外部系统联动，例如自动将词汇添加到生词本，等等。\n\n以上便是对快捷指令功能的基本介绍，除此之外 BabelDuck 还包含语音录入、自动播放语音、消息编辑等更多功能，你现在可以新建一个对话自由探索这些功能了！`,
            ...
            ja: {
                translation: {
                    ...
                    'sendTips': 'Enterキーで送信、Shift+Enterで改行',
